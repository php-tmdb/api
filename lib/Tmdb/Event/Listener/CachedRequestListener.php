 ...
 *
 * Class CachedRequestListener
 * @package Tmdb\Event\Listener
 */
class CachedRequestListener extends RequestListener
{
    /**
    ...
    public function __construct(
        ...
        $this->httpCachePlugin = CachePlugin::serverCache($this->cache, $this->streamFactory, $this->options);
    }
        ...
        try {
            ...
            $response->then(
                function ($result) use ($beforeRequestEvent) {
                    return $beforeRequestEvent->setResponse($result);
                }
            );
