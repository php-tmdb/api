...
class TvSeason extends AbstractApi
{
     ...
     */
    public function getSeason(int $tvshow_id, int $season_number, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getCredits($tvshow_id, $season_number, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getExternalIds($tvshow_id, $season_number, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getImages($tvshow_id, $season_number, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getVideos($tvshow_id, $season_number, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getChanges($tvshow_id, $season_number, array $parameters = [], array $headers = []): array
    {
