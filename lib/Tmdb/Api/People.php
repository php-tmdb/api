...
class People extends AbstractApi
{
     ...
     */
    public function getPerson($person_id, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getCombinedCredits($person_id, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getMovieCredits($person_id, array $parameters = [], array $headers = []): array
    {
     ...
     * This will provide details about which episode and/or season the credit is for.
     */
    public function getTvCredits($person_id, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getImages($person_id, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getChanges($person_id, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getExternalIds($person_id, array $parameters = [], array $headers = []): array
    {
     ...
     */
    public function getTaggedImages($person_id, array $parameters = [], array $headers = []): array
    {
