...
class TvEpisodeGroupRepository extends AbstractRepository
{
     ...
     */
    public function load($episode_group_id, array $parameters = [], array $headers = []): ?\Tmdb\Model\Tv\EpisodeGroup
    {
    ...
    #[\Override]
    public function getFactory(): \Tmdb\Factory\TvEpisodeGroupFactory
    {
