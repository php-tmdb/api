...
class AvatarFactory extends AbstractFactory
{
    ...
    public function create(array $data = [])
    {
        foreach ($data as $type => $content) {
            ...
            return match ($type) {
                'gravatar' => $this->hydrate(new Gravatar(), $content),
                default => throw new InvalidArgumentException(\sprintf('The avatar type "%s" has not been defined in the factory "%s".', $type, self::class)),
            };
        }
